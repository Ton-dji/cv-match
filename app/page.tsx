...
export default function Dashboard() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-slate-100">
      <header className="bg-white border-b border-slate-200/50 py-4 px-4 sm:px-6 flex flex-col sm:flex-row items-center justify-between sticky top-0 z-20">
      ...
      <div className="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <motion.div 
            ...
            id="profile"
          >
            <div className="bg-white rounded-2xl border border-white shadow-xl shadow-slate-100 p-6 sm:p-8">
          ...
          <div className="lg:col-span-1 order-2 lg:order-2 space-y-6">
            ...
            <motion.div 
              className="bg-white rounded-2xl p-6 border border-white shadow-xl shadow-slate-100"
            >
